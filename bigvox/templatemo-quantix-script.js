...
const desktopQuery = window.matchMedia('(min-width: 765px)');

window.addEventListener('scroll', () => {
    if (!desktopQuery.matches) return; // só aplica acima de 764px
...
navToggle.addEventListener('click', () => {
    ...
    document.body.classList.toggle('menu-aberto', navLinks.classList.contains('open'));
});
